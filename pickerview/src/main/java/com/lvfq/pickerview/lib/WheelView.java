...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        labelSize = getResources().getDimensionPixelSize(R.dimen.pickerview_labletextsize);
    ...
    private void initPaints() {
        ...
        paintlableText.setColor(textColorCenter);
        paintlableText.setAntiAlias(true);
        paintlableText.setTextScaleX(1.1F);
        paintlableText.setTypeface(Typeface.MONOSPACE);
        paintlableText.setTextSize(labelSize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(label != null) {
            ...
            //靠右并留出空隙
            canvas.drawText(label, drawRightContentStart - CENTERCONTENTOFFSET, centerY, paintlableText);
        }
        counter = 0;
        while (counter < itemsVisible) {
            canvas.save();
     ...
     * @param labelSize
     */
    public void setLabelTestSize(float labelSize){
        labelSize = (int) (context.getResources().getDisplayMetrics().density * labelSize);
        paintlableText.setTextSize(labelSize);
    }
